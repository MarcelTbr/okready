...
app.controller('NewSemesterController', ['$scope', '$http', '$location', '$interval', '$timeout', '$window', '$rootScope', 'toaster', '$route',
    function ($scope, $http, $location, $interval, $timeout, $window, $rootScope, toaster, $route) {
            ...
            switch(step){
                case 2:
                    ...
                    if(cond1 && cond2){
                        ...
                        toaster.info("Please make sure all fields are full and checked");
                    }
                ...
                case 3:
                    ...
                    if(cond3) {
                        ...
                        toaster.info("Please fill in your Key Result fields and check the blue boxes.");
                    }
                ...
                case 4:
                    ...
                    if($scope.okr_array[$scope.curr_okr ].results.length <= 1 && $scope.okr_array[$scope.curr_okr].results[0].title == undefined){
                       toaster.info("Sorry you have to define at least one objective key result");
        ...
        $scope.ok = function(id, num){
            ...
            if($elem.val() !== "") {
                ...
                toaster.warning("Please define a value");
            }
        };
